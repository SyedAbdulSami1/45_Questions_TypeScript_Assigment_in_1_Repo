...
var guestList = ["Waqar", "Hassam", "Asif"];
console.log("".concat(guestList[2], " excused himself from coming for dinner."));
...
guestList.forEach(function (element) {
    console.log("Dear ".concat(element, ", you are invited to dinner."));
});
